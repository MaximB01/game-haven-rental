...
const translations: Translations = {
  ...
  // Status Page (Public)
  'statusPage.title': { nl: 'Systeem Status', en: 'System Status' },
  'statusPage.subtitle': { nl: 'Real-time overzicht van onze diensten', en: 'Real-time overview of our services' },
  ...
  'statusPage.unknown': { nl: 'Status onbekend', en: 'Status unknown' },
  'statusPage.lastUpdated': { nl: 'Laatst bijgewerkt', en: 'Last updated' },
  'statusPage.services': { nl: 'Diensten', en: 'Services' },
  'statusPage.gameServers': { nl: 'Game Servers', en: 'Game Servers' },
};
